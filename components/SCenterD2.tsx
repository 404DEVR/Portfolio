...
const SCenterD2 = () => {
  ...
  return (
    <div
      id="projects"
      className="relative h-[50%] w-[100vw] bg-black z-[0] lg:hidden"
    >
      <div ref={card} className="overflow-hidden ">
        <div
          ref={slider}
          className="slider flex h-[100%] w-[520%] sm:w-[540%] md:w-[600%] z-[1] "
        >
      ...
      <div
        ref={textprojects}
        className="fixed top-[0] h-[100vh] w-[400%] flex z-[0] overflow-hidden"
      >
        <h1 className="relative text-[50vw] sm:text-[30vh] lg:text-[20vw] 2xl:text-[30vw] text-center text-[#ffffff] h-[10%] left-[5%] sm:left-[15%] top-[30%] z-10">
          Projects
        </h1>
        <h1 className="absolute text-[50vw] sm:text-[30vh] lg:text-[20vw] 2xl:text-[30vw] text-center text-[#f1f0f2] h-[10%] left-[5.7%]  opacity-40 sm:left-[15.2%] top-[31%]">
          Projects
        </h1>
      </div>
    </div>
